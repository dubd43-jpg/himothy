...
import { ShieldCheck, Lock, Eye, EyeOff, AlertTriangle, Crown, BarChart3, Target, TrendingUp, Users } from "lucide-react";
      ...
      <header className="bg-card border-b border-border px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-4">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <Link href="/admin/email" className="flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-md hover:bg-secondary transition-colors text-muted-foreground hover:text-foreground">
              <Lock className="w-3.5 h-3.5" /> Email
            </Link>
            <Link href="/admin/content" className="flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-md hover:bg-secondary transition-colors text-muted-foreground hover:text-foreground">
            ...
            <Link href="/admin/clv" className="flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-md hover:bg-secondary transition-colors text-muted-foreground hover:text-foreground">
              <TrendingUp className="w-3.5 h-3.5" /> CLV
            </Link>
            <Link href="/admin/line-alerts" className="flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-md hover:bg-secondary transition-colors text-muted-foreground hover:text-foreground">
              <AlertTriangle className="w-3.5 h-3.5" /> Line Alerts
            </Link>
            <Link href="/admin/customers" className="flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-md hover:bg-secondary transition-colors text-muted-foreground hover:text-foreground">
