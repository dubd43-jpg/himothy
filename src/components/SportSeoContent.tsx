...
export function KboSeoContent() {
  return (
    <article className={cardCls}>
      ...
      <p className="text-white/70 leading-relaxed mb-3">
        Heavy KBO favorites often price at -240 or worse on the moneyline — too steep for a single bet (our system caps ML picks at -185). For those games we convert to the run line at standard -110, where the value lives. Same approach as MLB: avoid the juice trap, get paid for being right.
      </p>
      <p className="text-white/70 leading-relaxed">
  ...
  return (
    <article className={cardCls}>
      ...
      <ul className="list-disc list-inside space-y-2 text-white/70 leading-relaxed mb-4">
        <li><strong>No moneyline picks steeper than -185</strong> on single plays — they pay too little to be worth the risk.</li>
